 ...
 *   id = "trustcard_gateway",
 *   label = "Trustcard Gateway",
 *   display_label = "Trustcard Payment Gateway",
 *    forms = {
 *     "offsite-payment" =
 *   "Drupal\commerce_trustpay\PluginForm\CommerceTrustcardPaymentForm",
 *   },
 *   requires_billing_information = FALSE,
 *   modes = {}
 * )
 */
class TrustcardGateway extends OffsitePaymentGatewayBase implements HasPaymentInstructionsFromOrderInterface, SupportsNotificationsInterface {
  ...
  public function buildPaymentInstructions (Order $order): array {
    ...
    return [
      ...
      '#context' => [
        ...
        'mode' => $this->getMode(),
        'url' => $trustpayRequest->generateRequestUrl(TrustpayRequestGenerator::TRUSTCARD_PAYMENT_REQUEST_URL),
